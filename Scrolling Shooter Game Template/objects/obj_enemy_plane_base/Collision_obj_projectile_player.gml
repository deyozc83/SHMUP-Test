...
// Checks the type of projectile is bullet
...
if (hp <= 0)
{
	...
	// Checks if less than 2 pickups exist
	if (instance_number(obj_pickup) < 2)
	{
		// Generates random number
		var _rng = random(100);
		
		// Checks against drop rate
		if (_rng < drop_rate)
		{
			// Creates a pickup
			instance_create_layer(x, y, "Pickups", obj_pickup);
		}
	}
...
else
{
	...
	// Chooses random and plays hit sound effect
